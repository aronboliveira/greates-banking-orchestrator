...
import com.pismochallenge.api.dynamo.AccountItem;
import com.pismochallenge.api.dynamo.OperationTypeItem;
import com.pismochallenge.api.dynamo.TransactionItem;
 ...
 * {@code pismo-api}. See handoff.md §17.2 for the key schema.
 */
@Configuration
@Profile("eks-dynamo")
public class AwsDynamoConfig {
    ...
    @Value("${aws.dynamodb.table-name:pismo-api}")
